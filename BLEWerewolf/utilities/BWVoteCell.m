...
-(void)setVoterString:(NSString*)voterString votedString:(NSString*)votedString count:(NSInteger)count cellSize:(CGSize)cellSize {
    ...
    self.voter = [[UILabel alloc]initWithFrame:CGRectMake(cellWidth*5/41, cellHeight*0.3, cellWidth*13/41, cellHeight*0.5)];
    ...
    self.voteder = [[UILabel alloc]initWithFrame:CGRectMake(cellWidth*24/41, cellHeight*0.3, cellWidth*13/41, cellHeight * 0.5)];
    ...
    self.counter.backgroundColor = [UIColor blackColor];
    self.voter.backgroundColor = [UIColor blackColor];
    self.voteder.backgroundColor = [UIColor blackColor];
