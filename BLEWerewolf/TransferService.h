...
サブサーバにおける動作は、RUleCheckSceneまでは個別にするが、RuleCheckSceneからは、宛先をコントロールしてメインサーバにそのまま中継する
...
「1:NNNNNN:T..T:C..C:P..P:message」の形式で送信する（NNNNNNはゲームID,T..TはシグナルID,C..Cは送り先ID,P..Pは送り元）
